...
public class MainActivity extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) 
	{
        ...
        writedatabutton = (Button) findViewById(R.id.writeexcelbutton);
        ...
        readdatabutton.setOnClickListener(new OnClickListener() {
			...
			{
				Toast.makeText(getApplication(), "Clicked readdatabutton",Toast.LENGTH_SHORT).show();
				readExcelFile(getApplication(),"CallList.xls");
	...
	writedatabutton.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View arg0) 
		{
			Toast.makeText(getApplication(), "Clicked writedatabutton",Toast.LENGTH_SHORT).show();
			saveExcelFile(getApplication(),"CallList.xls");
		}
	});
